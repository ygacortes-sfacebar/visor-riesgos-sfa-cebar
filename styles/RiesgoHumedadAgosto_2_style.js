var size = 0;
var placement = 'point';
function categories_RiesgoHumedadAgosto_2(feature, value, size, resolution, labelText,
...
var style_RiesgoHumedadAgosto_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("R-A.Pred_A");
    ...
    var style = categories_RiesgoHumedadAgosto_2(feature, value, size, resolution, labelText,
